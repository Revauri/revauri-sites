    ...
    <>
      ...
      {bannerOpen && (
        <div
          ...
          aria-live="polite"
          className="fixed inset-x-4 bottom-[max(1rem,env(safe-area-inset-bottom))] z-[80] mx-auto max-w-md rounded-2xl border border-brand-light-gray/60 bg-brand-white p-4 shadow-[var(--shadow-xl)] dark:border-brand-mid-gray/20 dark:bg-[#1a1a19] sm:inset-x-0 sm:bottom-0 sm:max-w-none sm:rounded-none sm:border-x-0 sm:border-b-0 sm:p-5 lg:inset-x-0 lg:bottom-0 lg:max-w-none lg:rounded-none lg:border-x-0 lg:border-b-0"
        >
          <div className="sm:mx-auto sm:flex sm:max-w-5xl sm:items-center sm:justify-between sm:gap-6">
            <div>
            ...
            <div className="mt-4 flex gap-2.5 sm:mt-0 sm:shrink-0">
              <button
                ...
                type="button"
                onClick={accept}
                className="flex-1 rounded-lg bg-brand-orange px-4 py-2.5 text-xs font-semibold text-white transition-colors hover:brightness-95 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-orange sm:flex-none"
              >
                Accept
              </button>
              <button
