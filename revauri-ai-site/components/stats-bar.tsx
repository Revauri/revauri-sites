...
const TECH_STACK = [
  {
    name: "Grok",
    description:
      "xAI's frontier model — fast, sharp reasoning for messy real-world work.",
    icon: (
      <svg className="h-9 w-9 text-brand-orange" viewBox="0 0 24 24" fill="currentColor" fillRule="evenodd">
  ...
  },
  {
    name: "Claude",
    description:
      "Anthropic's model for careful writing, long context, and sound judgment.",
    icon: (
      <svg className="h-9 w-9 text-brand-orange" viewBox="0 0 24 24" fill="currentColor">
  ...
  },
  {
    name: "ChatGPT",
    description:
      "OpenAI's flagship — the model most businesses already know and trust.",
    icon: (
      <svg className="h-10 w-10 text-brand-orange" viewBox="0 0 24 24" fill="currentColor">
  ...
  },
  {
    name: "Gemini",
    description:
      "Google's model for research, synthesis, and work across text and files.",
    icon: (
      <svg className="h-9 w-9 text-brand-orange" viewBox="0 0 24 24" fill="currentColor">
