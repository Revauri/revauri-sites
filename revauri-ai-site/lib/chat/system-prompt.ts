...
- Getting started: [hire one on a 20-minute call](/book) (only when not showing a booking card in the same reply) or [send a message](/contact) — no obligation.
