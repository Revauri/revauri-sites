    ...
    >
      ...
      <div className="flex items-center justify-between border-b border-brand-light-gray/60 px-[18px] pt-[18px] pb-3.5 dark:border-brand-mid-gray/20">
        ...
        <div className="flex items-center gap-1">
          ...
          <button
            onClick={onClose}
            className="flex h-[28px] w-auto items-center justify-center rounded-lg px-2 text-brand-dark transition-colors hover:bg-brand-light-gray/50 active:scale-[0.92] active:bg-brand-light-gray/70 dark:text-brand-cream sm:w-[28px] sm:px-0"
            aria-label="Close chat"
          >
            <X className="hidden h-[18px] w-[18px] sm:block" />
      ...
      <div>
        <form
          ...
          className="border-t border-brand-light-gray/60 px-4 pt-3.5 pb-2.5 dark:border-brand-mid-gray/20"
        >
          <div className="flex items-center gap-2 rounded-full border border-transparent bg-brand-light-gray/40 px-4 py-2.5 transition-colors focus-within:border-brand-orange dark:bg-brand-light-gray/10">
            <textarea
              ref={textareaRef}
              value={draft}
              onChange={(e) => {
              ...
              className="flex-1 resize-none overflow-y-auto bg-transparent text-[15px] text-brand-dark placeholder:text-brand-mid-gray focus:outline-none dark:text-brand-cream"
            />
            <button
              type="submit"
              className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-brand-orange text-white transition-all hover:shadow-[0_0_14px_rgba(217,119,87,0.65)] hover:brightness-[1.04] active:scale-[0.92] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-orange"
            >
              <ArrowUp className="h-[18px] w-[18px]" />
            </button>
          </div>
        </form>
        <p className="pb-3.5 pt-2.5 text-center text-[10.5px] uppercase tracking-[0.08em] text-brand-mid-gray">
