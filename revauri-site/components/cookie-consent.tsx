    ...
    <>
      ...
      {bannerOpen && (
        <div
          ...
          aria-live="polite"
          className="fixed inset-x-4 bottom-4 z-[80] mx-auto max-w-md rounded-2xl border border-brand-light-gray/60 bg-brand-white p-5 shadow-[var(--shadow-xl)] dark:border-brand-mid-gray/20 dark:bg-[#1a1a19] sm:inset-x-auto sm:left-5"
        >
          ...
          <div className="mt-4 flex gap-2.5">
            <button
              ...
              type="button"
              onClick={accept}
              className="flex-1 rounded-lg bg-brand-orange px-4 py-2.5 text-xs font-semibold text-white transition-colors hover:brightness-95 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-orange"
            >
              Accept analytics
            </button>
            <button
