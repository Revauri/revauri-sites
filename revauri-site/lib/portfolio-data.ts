...
export const PROJECTS: readonly PortfolioProject[] = [
  {
    ...
    gallery: [
      { src: "/portfolio/cryptrac/gallery-1.png", alt: "Payment link creation form with live checkout preview", width: 1600, height: 1000 },
      { src: "/portfolio/cryptrac/gallery-2.png", alt: "Public checkout page at /pay/[link_id]", width: 1600, height: 1000 },
      { src: "/portfolio/cryptrac/gallery-3.png", alt: "Merchant dashboard payment history with status badges", width: 1600, height: 1000 },
      { src: "/portfolio/cryptrac/gallery-4.png", alt: "Supported cryptocurrencies grid", width: 1600, height: 1000 },
      { src: "/portfolio/cryptrac/gallery-5.png", alt: "Pricing page with the $19 and $29 plans", width: 1600, height: 1000 },
    ],
    challenge:
  ...
  },
  {
    ...
    gallery: [
      { src: "/portfolio/ultaura/gallery-1.png", alt: "Dashboard home for family members", width: 1600, height: 1000 },
      { src: "/portfolio/ultaura/gallery-2.png", alt: "Line detail page with usage, schedule, and reminders", width: 1600, height: 1000 },
      { src: "/portfolio/ultaura/gallery-3.png", alt: "Insights hub showing mood, memory, and safety signals", width: 1600, height: 1000 },
      { src: "/portfolio/ultaura/gallery-4.png", alt: "Pricing page with Care, Comfort, and Family plans", width: 1600, height: 1000 },
      { src: "/portfolio/ultaura/gallery-5.png", alt: "Health profile / admin view", width: 1600, height: 1000 },
    ],
    challenge:
