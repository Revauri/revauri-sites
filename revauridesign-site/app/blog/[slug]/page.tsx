...
export default async function BlogPostPage(
  ...
  const structuredData = {
    ...
    headline: post.title,
    description: post.description,
    ...(post.image ? { image: `https://www.revauridesign.com${post.image}` } : {}),
    ...
    mainEntityOfPage: `https://www.revauridesign.com/blog/${post.slug}`,
  };
    ...
    itemListElement: [
      {
        ...
        position: 1,
        name: "Blog",
        item: "https://www.revauridesign.com/blog",
      },
      {
        "@type": "ListItem",
        position: 2,
        name: post.title,
        item: `https://www.revauridesign.com/blog/${post.slug}`,
      },
    ],
  };
