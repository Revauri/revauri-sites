...
function openContactEmail(event: FormEvent<HTMLFormElement>) {
  ...
  window.location.href = `mailto:${CONTACT_EMAIL}?subject=${encodeURIComponent("New message from revauridesign.com")}&body=${encodeURIComponent(lines.join("\n\n"))}`;
}
        ...
        <FadeInWhenVisible className="lg:sticky lg:top-28">
          ...
          <ul className="mt-8 space-y-4 text-sm">
            <ContactMethod
              ...
              label="david.mercer@revauridesign.com"
            />
            <ContactMethod
              href="/book"
