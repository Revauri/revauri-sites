    ...
    <section className="relative overflow-hidden bg-brand-cream">
      <div className="mx-auto grid max-w-6xl grid-cols-1 gap-12 px-6 py-24 lg:grid-cols-2 lg:py-32">
        <div className="flex flex-col justify-center">
          <h1
            className="text-4xl font-bold leading-[1.1] tracking-tight text-brand-dark opacity-0 animate-fade-in-up sm:text-5xl lg:text-6xl"
          >
      ...
      <div className="h-px bg-brand-light-gray" />
    </section>
  );
}
