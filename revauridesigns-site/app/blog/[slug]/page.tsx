...
export default async function BlogPostPage(
  ...
  const structuredData = {
    ...
    headline: post.title,
    description: post.description,
    ...(post.image ? { image: `https://www.revauridesigns.com${post.image}` } : {}),
    ...
    mainEntityOfPage: `https://www.revauridesigns.com/blog/${post.slug}`,
  };
    ...
    itemListElement: [
      {
        ...
        position: 1,
        name: "Blog",
        item: "https://www.revauridesigns.com/blog",
      },
      {
        "@type": "ListItem",
        position: 2,
        name: post.title,
        item: `https://www.revauridesigns.com/blog/${post.slug}`,
      },
    ],
  };
