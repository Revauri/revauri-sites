  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "Just send an email to ryan.calloway@revauridesigns.com with what you need. Most updates go live within 24 hours. For larger changes, we'll scope it and give you a timeline.",
      },
      {
