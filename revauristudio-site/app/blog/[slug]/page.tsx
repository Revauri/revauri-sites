...
export default async function BlogPostPage(
  ...
  const structuredData = {
    ...
    headline: post.title,
    description: post.description,
    ...(post.image ? { image: `https://revauristudio.com${post.image}` } : {}),
    ...
    mainEntityOfPage: `https://revauristudio.com/blog/${post.slug}`,
  };
    ...
    itemListElement: [
      {
        ...
        position: 1,
        name: "Blog",
        item: "https://revauristudio.com/blog",
      },
      {
        "@type": "ListItem",
        position: 2,
        name: post.title,
        item: `https://revauristudio.com/blog/${post.slug}`,
      },
    ],
  };
