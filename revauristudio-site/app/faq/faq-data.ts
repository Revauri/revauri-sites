    ...
    items: [
      {
        ...
        answer:
          "An AI employee for the work you’d otherwise hire someone to do. You name the job. We build the workflow around how you already run, and we run it. After setup, you are not living in the busywork. A lot cheaper than a person on payroll.",
      },
      {
        question: "Is this cheaper than hiring someone?",
        answer:
          "Yes. That’s the point. We quote the job on a short call. There is no public price list because the number depends on the work.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "First, costs, overhead, payroll, and headaches drop, so more of the money stays yours. Then missed calls, quiet leads, and dead quotes stop leaking, so more work comes in.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "Not on this product. Website work is separate and only worth doing if the site itself is the leak — that is a separate quote.",
      },
    ],
  },
];
