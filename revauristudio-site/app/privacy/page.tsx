    ...
    <div>
      ...
      <article className="prose prose-neutral mx-auto max-w-3xl px-6 py-10 dark:prose-invert md:py-16 lg:py-20 [&_h2]:text-brand-dark [&_h2]:dark:text-brand-cream [&_h2]:text-xl [&_h2]:font-semibold [&_h2]:mt-10 [&_h2]:mb-4 [&_h3]:text-brand-dark [&_h3]:dark:text-brand-cream [&_h3]:text-lg [&_h3]:font-medium [&_h3]:mt-6 [&_h3]:mb-3 [&_p]:text-brand-dark/70 [&_p]:dark:text-brand-cream/70 [&_p]:leading-relaxed [&_li]:text-brand-dark/70 [&_li]:dark:text-brand-cream/70 [&_a]:text-brand-orange [&_a]:hover:underline">
        ...
        <p>
          ...
          use, and share information when you visit revauristudio.com, receive communications from us, or engage with our
        ...
        <ul>
          ...
          <li>Business name and a description of the work you want handed off when you contact us or book a call</li>
          <li>
        ...
        <ul>
          <li>To build, run, and improve the AI workflows we operate for you</li>
          ...
          <li>To send you updates about the workflows we run for you or our services (if applicable)</li>
        ...
        <p>
          ...
          <a href="mailto:leah.donovan@revauristudio.com">leah.donovan@revauristudio.com</a>.
        </p>
        ...
        <p>
          ...
          <a href="mailto:leah.donovan@revauristudio.com">leah.donovan@revauristudio.com</a> with the subject line &quot;Privacy
        ...
        <p>
          ...
          at:{" "}
          <a href="mailto:leah.donovan@revauristudio.com">leah.donovan@revauristudio.com</a>. You may also write to us at:
        </p>
        <p>
          Revauri LLC<br />
