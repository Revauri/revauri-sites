...
export default function TermsPage() {
  return (
    <div>
      <PageHero
        badge={PAGE_HEROES.terms.badge}
        title={PAGE_HEROES.terms.title}
      ...
      <article className="prose prose-neutral mx-auto max-w-3xl px-6 py-10 dark:prose-invert md:py-16 lg:py-20 [&_h2]:text-brand-dark [&_h2]:dark:text-brand-cream [&_h2]:text-xl [&_h2]:font-semibold [&_h2]:mt-10 [&_h2]:mb-4 [&_h3]:text-brand-dark [&_h3]:dark:text-brand-cream [&_h3]:text-lg [&_h3]:font-medium [&_h3]:mt-6 [&_h3]:mb-3 [&_p]:text-brand-dark/70 [&_p]:dark:text-brand-cream/70 [&_p]:leading-relaxed [&_li]:text-brand-dark/70 [&_li]:dark:text-brand-cream/70 [&_a]:text-brand-orange [&_a]:hover:underline">
        ...
        <h2>1. Agreement</h2>
        <p>
          By accessing or using revauristudio.com and engaging with Revauri LLC&apos;s
        ...
        <ul>
          ...
          <li>Website design and development, which is a separate Revauri product quoted separately and is not part of this product</li>
        </ul>
        <p>
        ...
        <ul>
          <li>You may pause or cancel the hire at any time with fourteen (14) days&apos; written notice to{" "}<a href="mailto:leah.donovan@revauristudio.com">leah.donovan@revauristudio.com</a></li>
        ...
        <p>
          ...
          <a href="mailto:leah.donovan@revauristudio.com">leah.donovan@revauristudio.com</a>. You may also
          write to us at:<br />
          Revauri LLC<br />
